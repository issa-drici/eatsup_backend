...
return [
    ...
    | à adapter chaque message ici selon vos besoins.
    |
    */
    ...
    | pour les attributs en utilisant la convention "attribute.rule" pour
    | nommer les lignes. Cela vous permet de définir rapidement un message
    | de langue personnalisé pour une règle d'attribut spécifique.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Les lignes de langue suivantes sont utilisées pour échanger l'espace
    ...
    */
    ...
    'attributes' => [
        ...
        'user_plan' => 'plan d\'utilisateur',
        'user_subscription_status' => 'statut d\'abonnement',
        'trial_ends_at' => 'date de fin de l\'essai',
    ],
